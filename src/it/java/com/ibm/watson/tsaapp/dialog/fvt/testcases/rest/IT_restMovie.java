...
public class IT_restMovie extends SetupMethod{
	...
	public IT_restMovie(BaseQuestion quest) {
		this.question = quest;
	}

	@Parameters(name = "Movie Questions")
	public static Iterable<BaseQuestion> data() {
		ArrayList<BaseQuestion> questions = new ArrayList<BaseQuestion>();		
		questions = Utils.getQuestions(MOVIE_JSON_FILE, false);
	...
	/**
	 *<ul>
	 *<li><B>Info: </B>Ask movie question with the expected response to ask make a request for a movie type</li>
	 ...
	 *<li><B>Verify: </B>Validate that the response returns expected results (movies or no movies)</li>
	 *</ul>
	 */
	@Test
	public void movieQuestions() {
