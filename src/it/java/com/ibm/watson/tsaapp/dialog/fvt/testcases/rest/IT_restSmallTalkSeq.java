...
public class IT_restSmallTalkSeq extends SetupMethod{
	...
	public IT_restSmallTalkSeq(BaseQuestion quest) {
		this.question = quest;
	}

	@Parameters(name = "Small Talk sequence question")
	public static Iterable<BaseQuestion> data() {

		ArrayList<BaseQuestion> questions = new ArrayList<BaseQuestion>();		
		questions = Utils.getQuestions(SMALL_TALK_QUESTION, true);
	...
	/**
	 *<ul>
	 *<li><B>Info: </B>Ask a series of small talk questions</li>
