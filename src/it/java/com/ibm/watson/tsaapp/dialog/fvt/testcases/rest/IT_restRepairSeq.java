...
public class IT_restRepairSeq extends SetupMethod{
	...
	public IT_restRepairSeq(BaseQuestion quest) {
		this.question = quest;
	}

	@Parameters(name = "Repair Sequence questions")
	public static Iterable<BaseQuestion> data() {
		
		ArrayList<BaseQuestion> questions = new ArrayList<BaseQuestion>();		
		questions = Utils.getQuestions(REP_SEQ_QUESTION, true);
	...
	/**
	 *<ul>
	 *<li><B>Info: </B>Test a series of repair sequence question designed to redirect the user</li>
	 *<li><B>Step: </B>Connect to Showcase Dialog app using initchat rest api call</li>
	 *<li><B>Step: </B>Ask a series of repair sequence question</li>
