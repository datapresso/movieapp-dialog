...
package com.ibm.watson.tsaapp.dialog.fvt.rest;
...
import com.ibm.watson.tsaapp.dialog.fvt.appObject.BaseResponse;
...
public class RestAPI {
    ...
    public static String restURL = "/watson-tsaapp-dialog/api/bluemix";
    ...
    public void ask(BaseQuestion question){
        ...
        if(!question.getPartOfConversation()){
            String result = get(initchat).asString();
            System.out.println("*************************RESPONSE FROM INITCHAT: \n" + result + "\n");
            JsonPath initChat = new JsonPath(result);
