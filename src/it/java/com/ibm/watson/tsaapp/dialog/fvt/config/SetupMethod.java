...
package com.ibm.watson.tsaapp.dialog.fvt.config;
...
public class SetupMethod {
	...
	public static final String CONTEXT_ROOT = "/watson-tsaapp-dialog/dist/index.html#/";
	...
	public static String jsonPath() {
		...
		if(path == null){
	        ...
	        path = userDirectory + "/watsonBluemix/watson-tsaapp-dialog";
		}
		return path;	
	}
